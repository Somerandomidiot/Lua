-- Load the Visual UI Library from GitHub
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/VisualRoblox/Roblox/main/UI-Libraries/Visual%20UI%20Library/Source.lua'))()

-- Creating Window
local Window = Library:CreateWindow(
	'Hub Name',          -- Name of the UI.
	'Game Name',         -- Name of the Game.
	'Visual UI Library', -- Text that shows in the intro screen.
	'rbxassetid://10618928818', -- URL of the icon that shows in the intro screen.
	false,               -- If true, themes will be disabled; if false, themes will be enabled (for performance).
	'VisualUIConfigs',   -- The path that the config folder should be in your exploit's workspace folder.
	'Default'            -- The name of a pre-made theme or a table with your custom theme.
)
...
local Tab = Window:CreateTab(
	'Tab',              -- Name of the tab.
	true,               -- Tab visibility.
	'rbxassetid://3926305904', -- Tab Image URL.
	Vector2.new(0, 0), -- Tab Image RectOffset.
	Vector2.new(36, 36)   -- Tab Image RectSize.
)

-- Creating Sections
local Section = Tab:CreateSection('Section') -- Name of the section.

-- Creating Labels
local Label = Section:CreateLabel('Label') -- Label text.

-- Updating Labels
Label:UpdateLabel('New Text') -- New label text.

-- Creating Paragraphs
local Paragraph = Section:CreateParagraph('Paragraph', 'Content') -- Title of the paragraph, Content of the paragraph.

-- Updating Paragraphs
Paragraph:UpdateParagraph('New Title', 'New Text') -- New title of the paragraph, New content of the paragraph.

-- Creating Buttons
local Button = Section:CreateButton('Button', function()
	print('Button Pressed')
end)
-- Name of the button, Function / Callback of the button.

-- Creating Sliders
local Slider = Section:CreateSlider('Slider', 1, 100, 50, Color3.fromRGB(0, 125, 255), function(Value)
	print(Value)
end)
-- Name of the slider, Minimum value of the slider, Maximum value of the slider, Default value of the slider,
-- Color of the slider, Function / Callback of the slider.

-- Creating Textboxes
local Textbox = Section:CreateTextbox('Textbox', 'Input', function(Value)
	print(Value)
end)
-- Name of the textbox, Placeholder of the textbox, Function / Callback of the textbox.

-- Creating Keybinds
local Keybind = Section:CreateKeybind('Keybind', 'F', function()
	print('Key Pressed')
end)
-- Name of the keybind, Default KeyCode, Function / Callback of the keybind.

-- Creating Toggles
local Toggle = Section:CreateToggle('Toggle', true, Color3.fromRGB(0, 125, 255), 0.25, function(Value)
	print(Value)
end)
-- Name of the toggle, Default value of the toggle, Color of the toggle, Debounce of the toggle,
-- Function / Callback of the toggle.

-- Creating Dropdowns
local Dropdown = Section:CreateDropdown('Dropdown', {'1', '2', '3', '4', '5'}, '1', 0.25, function(Value)
	print(Value)
end)
-- Name of the dropdown, Dropdown options, Default Option of the dropdown, Debounce of the dropdown opening and closing,
-- Function / Callback of the dropdown.

-- Updating Dropdowns
Dropdown:UpdateDropdown({'1', '2', '2'}) -- New list of dropdown options.

-- Creating Colorpickers
local Colorpicker = Section:CreateColorpicker('Colorpicker', Color3.fromRGB(0, 125, 255), 0.25, function(Value)
	print(Value)
end)
-- Name of the colorpicker, Default color of the colorpicker, Debounce of the colorpicker opening and closing,
-- Function / Callback of the colorpicker.

-- Creating Images
local Image = Section:CreateImage('Name', 'rbxassetid://10618928818', UDim2.new(0, 200, 0, 200))
-- Name of the Image, Asset ID, The size that the image should be.

-- Updating Images
Image:UpdateImage('rbxassetid://10580575081', UDim2.new(0, 200, 0, 200))
-- New Asset ID, The size that the image should be.

-- Creating Notifications
Library:CreateNotification('Notification Title', 'Notification Text', 5)
-- Title of the notification, The text of the notification, The time the notification is on-screen for.

-- Creating Prompts
-- Just Text
Library:CreatePrompt('Text', 'Prompt Title', 'Prompt Text', 'Alright')
-- The type of prompt, The title of the prompt, The text of the prompt, The name of the prompt button (button has no callback).
...
-- The type of prompt, The title of the prompt, The text of the prompt,
-- The name of the button, The callback of the button.
...
-- The type of prompt, The title of the prompt, The text of the prompt,
-- The name of the first button, The callback of the first button,
-- The name of the second button, The callback of the second button.

-- Update UI Transparency
Library:SetTransparency(0.5, true)
-- The new background transparency of the UI, If true, the background transparency of notifications will be changed.

-- Config System
-- Creating / Saving Configs
Library:SaveConfig('Config')
-- The name of the config, If there is no config with the name, it will create one.
-- If one with the name already exists, it will overwrite it.
...
-- The name of the theme to change to or a custom theme.
...
ScreenGui.Name = "Better Toggle bruv"
...
Frame.Position = UDim2.new(0.915000021, 0, 0.009, 0)
...
ImageButton.Image = "rbxassetid://13357163021"
ImageButton.MouseButton1Click:Connect(function() 
	
	frame = game.CoreGui.IdiotHub.Main
